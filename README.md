...
AWS | Kubernetes | Terraform | Docker | Grafana | Prometheus |
Loki | Jenkins | PostgreSQL
...
- **Supported** the migration of self-managed Kubernetes clusters to IPv6 EKS,
...
- **Deployed** and **maintained** Jenkins CI/CD for 100+ Engineers and 50+ pipelines,
...
- **Developed** a Python CLI to simplify the daily tasks for 100+ Engineers
  interacting with the Platform, saving 300+ hours per month of Engineers time.
...
- **Provided** Terraform modules to abstract complexity with out-of-the-box best
  practices for 100+ Engineers, reducing by 500% and 100% respectively the time
