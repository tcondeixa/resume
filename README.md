...
including the creating of abstractions to deploy all common use-cases.
- Migrated 30+ microservices to Kubernetes (AWS EKS) with no downtime,
including provisioning the Clusters and Observability.
- Introduced centrally provided terraform modules to abstract complexity
for 60+ developers.
- Developed a Python CLI to simplify the daily tasks for 60+ Developers.
